            ...
            switch ((_context2.prev = _context2.next)) {
              case 0:
                return _context2.abrupt(
                  'return',
                  _microBusinessParseServerCommon.ServiceBase.read(_schema.Tag, id, sessionToken, TagService.messagePrefix, function(query) {
            ...
            switch ((_context3.prev = _context3.next)) {
              case 0:
                return _context3.abrupt(
                  'return',
                  _microBusinessParseServerCommon.ServiceBase.update(_schema.Tag, info, sessionToken, TagService.messagePrefix),
                );
            ...
            switch ((_context4.prev = _context4.next)) {
              case 0:
                return _context4.abrupt(
                  'return',
                  _microBusinessParseServerCommon.ServiceBase.delete(_schema.Tag, id, sessionToken, TagService.messagePrefix),
                );
            ...
            switch ((_context5.prev = _context5.next)) {
              case 0:
                return _context5.abrupt(
                  'return',
                  _microBusinessParseServerCommon.ServiceBase.search(_schema.Tag, TagService.buildSearchQuery, criteria, sessionToken),
                );
            ...
            switch ((_context6.prev = _context6.next)) {
              case 0:
                return _context6.abrupt(
                  'return',
                  _microBusinessParseServerCommon.ServiceBase.count(TagService.buildSearchQuery, criteria, sessionToken),
                );
            ...
            switch ((_context7.prev = _context7.next)) {
              case 0:
                return _context7.abrupt(
                  'return',
                  _microBusinessParseServerCommon.ServiceBase.exists(TagService.buildSearchQuery, criteria, sessionToken),
                );
...
TagService.buildSearchQuery = function(criteria) {
  ...
  _microBusinessParseServerCommon.ServiceBase.addNumberSearchToQuery(conditions, query, 'level', 'level');
  ...
  if (conditions.has('forDisplay')) {
    var _value2 = conditions.get('forDisplay');

    query.equalTo('forDisplay', _value2);
  }

  if (conditions.has('parentTag')) {
    var _value3 = conditions.get('parentTag');

    if (_value3) {
      query.equalTo('parentTag', _value3);
    }
  }

  if (conditions.has('parentTagId')) {
    var _value4 = conditions.get('parentTagId');

    if (_value4) {
      query.equalTo('parentTag', _schema.Tag.createWithoutData(_value4));
    }
  }
