...
var createCriteriaWthoutConditions = function createCriteriaWthoutConditions() {
  return (0, _immutable.Map)({
    fields: _immutable.List.of('name', 'description', 'priceDetails', 'priceToDisplay', 'saving', 'savingPercentage', 'offerEndDate', 'status', 'special', 'barcode', 'size', 'imageUrl', 'productPageUrl', 'store', 'tags', 'crawledStoreProduct'),
    include_store: true,
    include_tags: true,
...
var createCriteria = function createCriteria(crawledProductPrice) {
  return (0, _immutable.Map)({
    conditions: (0, _immutable.Map)({
      ...
      priceDetails: crawledProductPrice ? crawledProductPrice.get('priceDetails') : (0, _immutable.Map)({ price: chance.floating({ min: 0, max: 1000 }) }),
