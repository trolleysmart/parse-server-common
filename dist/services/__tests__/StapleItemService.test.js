...
var createCriteriaWthoutConditions = function createCriteriaWthoutConditions() {
  return (0, _immutable.Map)({
    fields: _immutable.List.of('name', 'description', 'imageUrl', 'user', 'tags'),
    includeUser: true,
    includeTags: true,
  });
};
...
describe('create', function() {
  test(
    'should return the created staple item Id',
    _asyncToGenerator(
...
describe('read', function() {
  test(
    'should reject if the provided staple item Id does not exist',
    _asyncToGenerator(
            ...
            while (1) {
              switch ((_context5.prev = _context5.next)) {
                ...
                case 6:
                  ...
                  expect(_context5.t0.getErrorMessage()).toBe('No staple item found with Id: ' + stapleItemId);
  ...
  test(
    'should read the existing staple item',
    _asyncToGenerator(
      regeneratorRuntime.mark(function _callee6() {
        var _ref10, expectedStapleItem, expectedStapleTemplates, expectedTags, stapleItemId, stapleItem;
...
describe('update', function() {
            ...
            while (1) {
              switch ((_context7.prev = _context7.next)) {
                ...
                case 18:
                  ...
                  expect(_context7.t5.getErrorMessage()).toBe('No staple item found with Id: ' + stapleItemId);
  ...
  test(
    'should return the Id of the updated staple item',
    _asyncToGenerator(
  ...
  test(
    'should update the existing staple item',
    _asyncToGenerator(
      regeneratorRuntime.mark(function _callee9() {
        var _ref15, expectedStapleItem, expectedStapleTemplates, expectedTags, stapleItemId, stapleItem;
...
describe('delete', function() {
            ...
            while (1) {
              switch ((_context10.prev = _context10.next)) {
                ...
                case 6:
                  ...
                  expect(_context10.t0.getErrorMessage()).toBe('No staple item found with Id: ' + stapleItemId);
  ...
  test(
    'should delete the existing staple item',
    _asyncToGenerator(
            ...
            while (1) {
              switch ((_context11.prev = _context11.next)) {
                ...
                case 14:
                  ...
                  expect(_context11.t2.getErrorMessage()).toBe('No staple item found with Id: ' + stapleItemId);
...
describe('search', function() {
  test(
    'should return no staple item if provided criteria matches no staple item',
    _asyncToGenerator(
  ...
  test(
    'should return the staple item matches the criteria',
    _asyncToGenerator(
      regeneratorRuntime.mark(function _callee14() {
        var _ref20, expectedStapleItem, expectedStapleTemplates, expectedTags, results, stapleItems;
  ...
  test(
    ...
    _asyncToGenerator(
      regeneratorRuntime.mark(function _callee17() {
        var _ref24, expectedStapleItem, expectedStapleTemplates, expectedTags, results, stapleItems, result;
...
describe('exists', function() {
  test(
    'should return false if no staple item match provided criteria',
    _asyncToGenerator(
  ...
  test(
    'should return true if any staple item match provided criteria',
    _asyncToGenerator(
...
describe('count', function() {
  test(
    'should return 0 if no staple item match provided criteria',
    _asyncToGenerator(
  ...
  test(
    'should return the count of staple item match provided criteria',
    _asyncToGenerator(
