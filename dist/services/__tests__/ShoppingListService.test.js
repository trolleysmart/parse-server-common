...
describe('create', function() {
  test(
    'should return the created shopping list Id',
    _asyncToGenerator(
  ...
  test(
    'should create the shopping list',
    _asyncToGenerator(
...
describe('read', function() {
  test(
    'should reject if the provided shopping list Id does not exist',
    _asyncToGenerator(
  ...
  test(
    'should read the existing shopping list',
    _asyncToGenerator(
            ...
            while (1) {
              switch ((_context6.prev = _context6.next)) {
                ...
                case 11:
                  ...
                  (0, _ShoppingList.expectShoppingList)(shoppingList, expectedShoppingList, {
                    shoppingListId: shoppingListId,
                    expectedUser: expectedUser,
                    expectedSharedWithUsers: expectedSharedWithUsers,
                  });
...
describe('update', function() {
  ...
  test(
    'should return the Id of the updated shopping list',
    _asyncToGenerator(
  ...
  test(
    'should update the existing shopping list',
    _asyncToGenerator(
...
describe('delete', function() {
  ...
  test(
    'should delete the existing shopping list',
    _asyncToGenerator(
...
describe('search', function() {
  test(
    'should return no shopping list if provided criteria matches no shopping list',
    _asyncToGenerator(
  ...
  test(
    'should return the shopping list matches the criteria',
    _asyncToGenerator(
              ...
              switch ((_context14.prev = _context14.next)) {
                ...
                case 13:
                  ...
                  shoppingLists.forEach(function(shoppingList) {
                    ...
                    (0,
                    _ShoppingList.expectShoppingList)(shoppingList, expectedShoppingList, { shoppingListId: shoppingList.get('id'), expectedUser: expectedUser, expectedSharedWithUsers: expectedSharedWithUsers });
                  });
...
describe('exists', function() {
  test(
    'should return false if no shopping list match provided criteria',
    _asyncToGenerator(
  ...
  test(
    'should return true if any shopping list match provided criteria',
    _asyncToGenerator(
...
describe('count', function() {
  test(
    'should return 0 if no shopping list match provided criteria',
    _asyncToGenerator(
  ...
  test(
    'should return the count of shopping list match provided criteria',
    _asyncToGenerator(
