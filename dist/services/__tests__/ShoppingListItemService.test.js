...
describe('create', function() {
  test(
    'should return the created shopping list item Id',
    _asyncToGenerator(
  ...
  test(
    'should create the shopping list item',
    _asyncToGenerator(
...
describe('read', function() {
  test(
    'should reject if the provided shopping list item Id does not exist',
    _asyncToGenerator(
  ...
  test(
    'should read the existing shopping list item',
    _asyncToGenerator(
...
describe('update', function() {
  ...
  test(
    'should return the Id of the updated shopping list item',
    _asyncToGenerator(
  ...
  test(
    'should update the existing shopping list item',
    _asyncToGenerator(
...
describe('delete', function() {
  ...
  test(
    'should delete the existing shopping list item',
    _asyncToGenerator(
...
describe('search', function() {
  test(
    'should return no shopping list item if provided criteria matches no shopping list item',
    _asyncToGenerator(
  ...
  test(
    'should return the shopping list item matches the criteria',
    _asyncToGenerator(
...
describe('exists', function() {
  test(
    'should return false if no shopping list item match provided criteria',
    _asyncToGenerator(
  ...
  test(
    'should return true if any shopping list item match provided criteria',
    _asyncToGenerator(
...
describe('count', function() {
  test(
    'should return 0 if no shopping list item match provided criteria',
    _asyncToGenerator(
  ...
  test(
    'should return the count of shopping list item match provided criteria',
    _asyncToGenerator(
