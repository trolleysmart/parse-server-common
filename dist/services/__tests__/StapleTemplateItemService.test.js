...
var createCriteriaWthoutConditions = function createCriteriaWthoutConditions() {
  return (0, _immutable.Map)({
    fields: _immutable.List.of('name', 'description', 'imageUrl', 'stapleTemplates', 'tags'),
...
var createCriteria = function createCriteria(stapleTemplateItem) {
  return (0, _immutable.Map)({
    conditions: (0, _immutable.Map)({
      ...
      stapleTemplateIds: stapleTemplateItem
        ? stapleTemplateItem.get('stapleTemplateIds')
        : _immutable.List.of((0, _v2.default)(), (0, _v2.default)()),
...
describe('create', function() {
  test(
    'should return the created staple teplate item Id',
    _asyncToGenerator(
  ...
  test(
    'should create the staple teplate item',
    _asyncToGenerator(
...
describe('read', function() {
  test(
    'should reject if the provided staple teplate item Id does not exist',
    _asyncToGenerator(
            ...
            while (1) {
              switch ((_context5.prev = _context5.next)) {
                ...
                case 6:
                  ...
                  expect(_context5.t0.getErrorMessage()).toBe('No staple teplate item found with Id: ' + stapleTemplateItemId);
  ...
  test(
    'should read the existing staple teplate item',
    _asyncToGenerator(
...
describe('update', function() {
            ...
            while (1) {
              switch ((_context7.prev = _context7.next)) {
                ...
                case 18:
                  ...
                  expect(_context7.t5.getErrorMessage()).toBe('No staple teplate item found with Id: ' + stapleTemplateItemId);
  ...
  test(
    'should return the Id of the updated staple teplate item',
    _asyncToGenerator(
  ...
  test(
    'should update the existing staple teplate item',
    _asyncToGenerator(
...
describe('delete', function() {
            ...
            while (1) {
              switch ((_context10.prev = _context10.next)) {
                ...
                case 6:
                  ...
                  expect(_context10.t0.getErrorMessage()).toBe('No staple teplate item found with Id: ' + stapleTemplateItemId);
  ...
  test(
    'should delete the existing staple teplate item',
    _asyncToGenerator(
            ...
            while (1) {
              switch ((_context11.prev = _context11.next)) {
                ...
                case 14:
                  ...
                  expect(_context11.t2.getErrorMessage()).toBe('No staple teplate item found with Id: ' + stapleTemplateItemId);
...
describe('search', function() {
  test(
    'should return no staple teplate item if provided criteria matches no staple teplate item',
    _asyncToGenerator(
  ...
  test(
    'should return the staple teplate item matches the criteria',
    _asyncToGenerator(
...
describe('exists', function() {
  test(
    'should return false if no staple teplate item match provided criteria',
    _asyncToGenerator(
  ...
  test(
    'should return true if any staple teplate item match provided criteria',
    _asyncToGenerator(
...
describe('count', function() {
  test(
    'should return 0 if no staple teplate item match provided criteria',
    _asyncToGenerator(
  ...
  test(
    'should return the count of staple teplate item match provided criteria',
    _asyncToGenerator(
