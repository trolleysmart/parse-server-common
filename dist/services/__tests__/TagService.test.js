...
describe('read', function () {
  ...
  test('should read the existing tag', _asyncToGenerator(regeneratorRuntime.mark(function _callee6() {
    var _ref10, expectedTag, tagId, tag;
...
describe('update', function () {
  ...
  test('should return the Id of the updated tag', _asyncToGenerator(regeneratorRuntime.mark(function _callee8() {
    var _ref13, expectedTag, tagId, id;
  ...
  test('should update the existing tag', _asyncToGenerator(regeneratorRuntime.mark(function _callee9() {
    var _ref15, expectedTag, tagId, tag;
...
describe('search', function () {
  ...
  test('should return the products price matches the criteria', _asyncToGenerator(regeneratorRuntime.mark(function _callee14() {
    var _ref20, expectedTag, results, tags;
...
describe('searchAll', function () {
  ...
  test('should return the products price matches the criteria', _asyncToGenerator(regeneratorRuntime.mark(function _callee17() {
    var _ref24, expectedTag, results, tags, result;
