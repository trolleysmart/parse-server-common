...
describe('create', function () {
  test('should return the created store tag Id', _asyncToGenerator(regeneratorRuntime.mark(function _callee3() {
    var storeTagId;
  ...
  test('should create the store tag', _asyncToGenerator(regeneratorRuntime.mark(function _callee4() {
...
describe('read', function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 6:
            ...
            expect(_context5.t0.message).toBe('No store tag found with Id: ' + storeTagId);
  ...
  test('should read the existing store tag', _asyncToGenerator(regeneratorRuntime.mark(function _callee6() {
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 18:
            ...
            (0, _StoreTag.expectStoreTag)(storeTag, expectedStoreTag, { storeTagId: storeTagId, expectedStore: expectedStore, expectedTags: expectedTags });
...
describe('update', function () {
  test('should reject if the provided store tag Id does not exist', _asyncToGenerator(regeneratorRuntime.mark(function _callee7() {
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 18:
            ...
            expect(_context7.t5.message).toBe('No store tag found with Id: ' + storeTagId);
  ...
  test('should return the Id of the updated store tag', _asyncToGenerator(regeneratorRuntime.mark(function _callee8() {
  ...
  test('should update the existing store tag', _asyncToGenerator(regeneratorRuntime.mark(function _callee9() {
...
describe('delete', function () {
  test('should reject if the provided store tag Id does not exist', _asyncToGenerator(regeneratorRuntime.mark(function _callee10() {
    var storeTagId;
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          ...
          case 6:
            ...
            expect(_context10.t0.message).toBe('No store tag found with Id: ' + storeTagId);
  ...
  test('should delete the existing store tag', _asyncToGenerator(regeneratorRuntime.mark(function _callee11() {
    var storeTagId;
      ...
      while (1) {
        switch (_context11.prev = _context11.next) {
          ...
          case 14:
            ...
            expect(_context11.t2.message).toBe('No store tag found with Id: ' + storeTagId);
...
describe('search', function () {
  test('should return no store tag if provided criteria matches no store tag', _asyncToGenerator(regeneratorRuntime.mark(function _callee12() {
    var storeTags;
  ...
  test('should return the store tags matches the criteria', _asyncToGenerator(regeneratorRuntime.mark(function _callee14() {
        ...
        switch (_context14.prev = _context14.next) {
          ...
          case 20:
            ...
            storeTags.forEach(function (storeTag) {
              ...
              (0, _StoreTag.expectStoreTag)(storeTag, expectedStoreTag, { storeTagId: storeTag.get('id'), expectedStore: expectedStore, expectedTags: expectedTags });
            });
...
describe('searchAll', function () {
  test('should return no store tag if provided criteria matches no store tag', _asyncToGenerator(regeneratorRuntime.mark(function _callee15() {
  ...
  test('should return the store tags matches the criteria', _asyncToGenerator(regeneratorRuntime.mark(function _callee17() {
...
describe('exists', function () {
  test('should return false if no store tag match provided criteria', _asyncToGenerator(regeneratorRuntime.mark(function _callee18() {
  ...
  test('should return true if any store tag match provided criteria', _asyncToGenerator(regeneratorRuntime.mark(function _callee19() {
    var storeTags;
...
describe('count', function () {
  test('should return 0 if no store tag match provided criteria', _asyncToGenerator(regeneratorRuntime.mark(function _callee20() {
  ...
  test('should return the count of store tag match provided criteria', _asyncToGenerator(regeneratorRuntime.mark(function _callee21() {
    var storeTags;
