...
describe('create', function() {
  test(
    'should return the created user feedback Id',
    _asyncToGenerator(
  ...
  test(
    'should create the user feedback',
    _asyncToGenerator(
...
describe('read', function() {
  test(
    'should reject if the provided user feedback Id does not exist',
    _asyncToGenerator(
            ...
            while (1) {
              switch ((_context5.prev = _context5.next)) {
                ...
                case 6:
                  ...
                  expect(_context5.t0.getErrorMessage()).toBe('No user feedback found with Id: ' + userFeedbackId);
  ...
  test(
    'should read the existing user feedback',
    _asyncToGenerator(
            ...
            while (1) {
              switch ((_context6.prev = _context6.next)) {
                ...
                case 9:
                  ...
                  (0, _UserFeedback.expectUserFeedback)(userFeedback, expectedUserFeedback);
...
describe('update', function() {
            ...
            while (1) {
              switch ((_context7.prev = _context7.next)) {
                ...
                case 18:
                  ...
                  expect(_context7.t5.getErrorMessage()).toBe('No user feedback found with Id: ' + userFeedbackId);
  ...
  test(
    'should return the Id of the updated user feedback',
    _asyncToGenerator(
  ...
  test(
    'should update the existing user feedback',
    _asyncToGenerator(
...
describe('delete', function() {
  ...
  test(
    'should delete the existing user feedback',
    _asyncToGenerator(
            ...
            while (1) {
              switch ((_context11.prev = _context11.next)) {
                ...
                case 14:
                  ...
                  expect(_context11.t2.getErrorMessage()).toBe('No user feedback found with Id: ' + userFeedbackId);
...
describe('search', function() {
  test(
    'should return no user feedback if provided criteria matches no user feedback',
    _asyncToGenerator(
...
describe('exists', function() {
  test(
    'should return false if no user feedback match provided criteria',
    _asyncToGenerator(
  ...
  test(
    'should return true if any user feedback match provided criteria',
    _asyncToGenerator(
...
describe('count', function() {
  test(
    'should return 0 if no user feedback match provided criteria',
    _asyncToGenerator(
  ...
  test(
    'should return the count of user feedback match provided criteria',
    _asyncToGenerator(
