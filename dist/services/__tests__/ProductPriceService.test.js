...
var createCriteriaWthoutConditions = function createCriteriaWthoutConditions() {
  return (0, _immutable.Map)({
    fields: _immutable.List.of('name', 'description', 'priceDetails', 'priceToDisplay', 'saving', 'savingPercentage', 'offerEndDate', 'status', 'special', 'store', 'tags'),
    includeStore: true,
    includeTags: true
  });
};
              ...
              return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 10:
                      _context.t0 = _2.ProductPriceService;
                      _context.next = 13;
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.t0 = _2.ProductPriceService;
            _context3.next = 3;
            return (0, _ProductPrice.createProductPriceInfo)();
...
describe('read', function () {
  ...
  test('should read the existing product price', _asyncToGenerator(regeneratorRuntime.mark(function _callee6() {
    var _ref10, expectedProductPrice, expectedStore, expectedTags, productPriceId, productPrice;
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 11:
            ...
            (0, _ProductPrice.expectProductPrice)(productPrice, expectedProductPrice, { productPriceId: productPriceId, expectedStore: expectedStore, expectedTags: expectedTags });
...
describe('update', function () {
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            productPriceId = (0, _v2.default)();
            _context7.prev = 1;
            _context7.t0 = _2.ProductPriceService;
            _context7.t1 = _2.ProductPriceService;
            _context7.next = 6;
            return (0, _ProductPrice.createProductPriceInfo)();
  ...
  test('should update the existing product price', _asyncToGenerator(regeneratorRuntime.mark(function _callee9() {
    var _ref15, expectedProductPrice, expectedStore, expectedTags, productPriceId, productPrice;
    ...
    return regeneratorRuntime.wrap(function _callee11$(_context11) {
      while (1) {
        switch (_context11.prev = _context11.next) {
          case 0:
            _context11.t0 = _2.ProductPriceService;
            _context11.next = 3;
            return (0, _ProductPrice.createProductPriceInfo)();
...
describe('search', function () {
  ...
  test('should return the product price matches the criteria', _asyncToGenerator(regeneratorRuntime.mark(function _callee14() {
    var _ref20, expectedProductPrice, expectedStore, expectedTags, results, productPrices;
        ...
        switch (_context14.prev = _context14.next) {
              ...
              return regeneratorRuntime.wrap(function _callee13$(_context13) {
                while (1) {
                  switch (_context13.prev = _context13.next) {
                    case 0:
                      return _context13.abrupt('return', _2.ProductPriceService.create(expectedProductPrice));
          ...
          case 13:
            ...
            productPrices.forEach(function (productPrice) {
              ...
              (0, _ProductPrice.expectProductPrice)(productPrice, expectedProductPrice, { productPriceId: productPrice.get('id'), expectedStore: expectedStore, expectedTags: expectedTags });
            });
...
describe('searchAll', function () {
  ...
  test('should return the product price matches the criteria', _asyncToGenerator(regeneratorRuntime.mark(function _callee17() {
    var _ref24, expectedProductPrice, expectedStore, expectedTags, results, productPrices, result;
              ...
              return regeneratorRuntime.wrap(function _callee16$(_context16) {
                while (1) {
                  switch (_context16.prev = _context16.next) {
                    case 0:
                      return _context16.abrupt('return', _2.ProductPriceService.create(expectedProductPrice));
