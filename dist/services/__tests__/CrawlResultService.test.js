...
describe('create', function() {
  test(
    'should return the created crawl result Id',
    _asyncToGenerator(
  ...
  test(
    'should create the crawl result',
    _asyncToGenerator(
...
describe('read', function() {
  test(
    'should reject if the provided crawl result Id does not exist',
    _asyncToGenerator(
  ...
  test(
    'should read the existing crawl result',
    _asyncToGenerator(
            ...
            while (1) {
              switch ((_context6.prev = _context6.next)) {
                ...
                case 10:
                  ...
                  (0, _CrawlResult.expectCrawlResult)(crawlResult, expectedCrawlResult, {
                    crawlResultId: crawlResultId,
                    expectedCrawlSession: expectedCrawlSession,
                  });
...
describe('update', function() {
  ...
  test(
    'should return the Id of the updated crawl result',
    _asyncToGenerator(
  ...
  test(
    'should update the existing crawl result',
    _asyncToGenerator(
...
describe('delete', function() {
  ...
  test(
    'should delete the existing crawl result',
    _asyncToGenerator(
...
describe('search', function() {
  test(
    'should return no crawl result if provided criteria matches no crawl result',
    _asyncToGenerator(
              ...
              switch ((_context14.prev = _context14.next)) {
                ...
                case 12:
                  ...
                  crawlResults.forEach(function(crawlResult) {
                    ...
                    (
                      0,
                      _CrawlResult.expectCrawlResult
                    )(crawlResult, expectedCrawlResult, { crawlResultId: crawlResult.get('id'), expectedCrawlSession: expectedCrawlSession });
                  });
...
describe('exists', function() {
  test(
    'should return false if no crawl result match provided criteria',
    _asyncToGenerator(
  ...
  test(
    'should return true if any crawl result match provided criteria',
    _asyncToGenerator(
...
describe('count', function() {
  test(
    'should return 0 if no crawl result match provided criteria',
    _asyncToGenerator(
  ...
  test(
    'should return the count of crawl result match provided criteria',
    _asyncToGenerator(
