  ...
  return (0, _immutable.Map)({
    conditions: (0, _immutable.Map)({
      ...
      near_geoLocation: store
        ...
        : _microBusinessParseServerCommon.ParseWrapperService.createGeoPoint({
                              ...
                              while (1) {
                                switch ((_context.prev = _context.next)) {
                                  ...
                                  case 10:
                                    ...
                                    _context.next = 13;
                                    return _2.StoreService.create(
                                      createParentStore
                                        ? finalStore.merge((0, _immutable.Map)({ parentStoreId: parentStore.get('id') }))
                                        : finalStore,
                                    );
...
describe('create', function() {
  test(
    'should return the created store Id',
    _asyncToGenerator(
...
describe('read', function() {
  test(
    'should reject if the provided store Id does not exist',
    _asyncToGenerator(
  ...
  test(
    'should read the existing store',
    _asyncToGenerator(
            ...
            while (1) {
              switch ((_context6.prev = _context6.next)) {
                ...
                case 2:
                  ...
                  _context6.next = 6;
                  return _2.StoreService.create(parentStore);
...
describe('update', function() {
  ...
  test(
    'should return the Id of the updated store',
    _asyncToGenerator(
  ...
  test(
    'should update the existing store',
    _asyncToGenerator(
...
describe('delete', function() {
  ...
  test(
    'should delete the existing store',
    _asyncToGenerator(
...
describe('search', function() {
  test(
    'should return no store if provided criteria matches no store',
    _asyncToGenerator(
  ...
  test(
    'should return the store matches the criteria',
    _asyncToGenerator(
...
describe('exists', function() {
  test(
    'should return false if no store match provided criteria',
    _asyncToGenerator(
  ...
  test(
    'should return true if any store match provided criteria',
    _asyncToGenerator(
...
describe('count', function() {
  test(
    'should return 0 if no store match provided criteria',
    _asyncToGenerator(
  ...
  test(
    'should return the count of store match provided criteria',
    _asyncToGenerator(
