...
describe('create', function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            tagId = _context.sent;
            _context.next = 8;
            return _2.TagMappingService.create((0, _TagMapping.createTagMappingInfo)(storeId, tagId));
  ...
  test('should create the tag', _asyncToGenerator(regeneratorRuntime.mark(function _callee2() {
    var storeId, tagId, expectedTagMappingInfo, tagMappingId, tagMappingInfo;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 5:
            ...
            expectedTagMappingInfo = (0, _TagMapping.createTagMappingInfo)(tagId, storeId);
            _context2.next = 9;
...
describe('update', function () {
  test('should reject if the provided tag mapping Id does not exist', _asyncToGenerator(regeneratorRuntime.mark(function _callee5() {
    var tagMappingId, storeId, tagId;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 7:
            ...
            _context5.next = 10;
            return _2.TagMappingService.update((0, _TagMapping.createTagMappingInfo)(storeId, tagId).set('id', tagMappingId));
  ...
  test('should return the Id of the updated tag', _asyncToGenerator(regeneratorRuntime.mark(function _callee6() {
    var storeId, tagId, tagMappingId, id;
  ...
  test('should update the existing tag', _asyncToGenerator(regeneratorRuntime.mark(function _callee7() {
    var storeId, tagId, expectedTagMappingInfo, id, tagMappingId, tagMappingInfo;
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 5:
            ...
            expectedTagMappingInfo = (0, _TagMapping.createTagMappingInfo)(storeId, tagId);
            _context7.next = 9;
...
describe('delete', function () {
  ...
  test('should delete the existing tag', _asyncToGenerator(regeneratorRuntime.mark(function _callee9() {
    var storeId, tagId, tagMappingId;
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          ...
          case 5:
            ...
            _context9.next = 8;
            return _2.TagMappingService.create((0, _TagMapping.createTagMappingInfo)(tagId, storeId));
...
describe('search', function () {
  ...
  test('should return the tag mappings matches the criteria', _asyncToGenerator(regeneratorRuntime.mark(function _callee11() {
    var storeId, tagId, expectedTagMappingInfo, tagMappingId, tagMappingInfos, tagMappingInfo;
...
describe('searchAll', function () {
  ...
  test('should return the tag mappings matches the criteria', _asyncToGenerator(regeneratorRuntime.mark(function _callee13() {
    var storeId, tagId, expectedTagMappingInfo, tagMappingId1, tagMappingId2, result, tagMappings;
...
describe('exists', function () {
  ...
  test('should return true if any tag mapping match provided criteria', _asyncToGenerator(regeneratorRuntime.mark(function _callee15() {
    var storeId, tagId, tagMappingInfo, response;
      ...
      while (1) {
        switch (_context15.prev = _context15.next) {
          ...
          case 5:
            ...
            tagMappingInfo = (0, _TagMapping.createTagMappingInfo)(storeId, tagId);
            _context15.next = 9;
