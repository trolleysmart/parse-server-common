    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return _microBusinessParseServerCommon.ParseWrapperService.createQuery(_schema.StoreMasterProduct).equalTo('objectId', id).limit(1).find();
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return _microBusinessParseServerCommon.ParseWrapperService.createQuery(_schema.StoreMasterProduct).equalTo('objectId', info.get('id')).limit(1).find();
...
StoreMasterProductService.buildSearchQuery = function (criteria) {
  ...
  if (conditions.has('productPageUrl')) {
    var _value4 = conditions.get('productPageUrl');

    if (_value4) {
      query.equalTo('productPageUrl', _value4);
    }
  }
