...
var StapleItemService = function (_ServiceBase) {
  ...
  function StapleItemService() {
    ...
    return _possibleConstructorReturn(this, (StapleItemService.__proto__ || Object.getPrototypeOf(StapleItemService)).apply(this, arguments));
  }

  return StapleItemService;
}(_microBusinessParseServerCommon.ServiceBase);

StapleItemService.messagePrefix = 'No staple item found with Id: ';

StapleItemService.create = function () {
  var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(info, acl, sessionToken) {
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt('return', _microBusinessParseServerCommon.ServiceBase.create(_schema.StapleItem, info, acl, sessionToken));
...
StapleItemService.read = function () {
  var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(id, criteria, sessionToken) {
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            return _context2.abrupt('return', _microBusinessParseServerCommon.ServiceBase.read(_schema.StapleItem, id, sessionToken, StapleItemService.messagePrefix, function (query) {
              return StapleItemService.buildIncludeQuery(query, criteria);
            }));
...
StapleItemService.update = function () {
  var _ref3 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(info, sessionToken) {
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            return _context3.abrupt('return', _microBusinessParseServerCommon.ServiceBase.update(_schema.StapleItem, info, sessionToken, StapleItemService.messagePrefix));
...
StapleItemService.delete = function () {
  var _ref4 = _asyncToGenerator(regeneratorRuntime.mark(function _callee4(id, sessionToken) {
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            return _context4.abrupt('return', _microBusinessParseServerCommon.ServiceBase.delete(_schema.StapleItem, id, sessionToken, StapleItemService.messagePrefix));
...
StapleItemService.search = function () {
  var _ref5 = _asyncToGenerator(regeneratorRuntime.mark(function _callee5(criteria, sessionToken) {
    return regeneratorRuntime.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            return _context5.abrupt('return', _microBusinessParseServerCommon.ServiceBase.search(_schema.StapleItem, StapleItemService.buildSearchQuery, criteria, sessionToken));
...
StapleItemService.searchAll = function (criteria, sessionToken) {
  return _microBusinessParseServerCommon.ServiceBase.searchAll(_schema.StapleItem, StapleItemService.buildSearchQuery, criteria, sessionToken);
};

StapleItemService.count = function () {
  var _ref6 = _asyncToGenerator(regeneratorRuntime.mark(function _callee6(criteria, sessionToken) {
    return regeneratorRuntime.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            return _context6.abrupt('return', _microBusinessParseServerCommon.ServiceBase.count(StapleItemService.buildSearchQuery, criteria, sessionToken));
...
StapleItemService.exists = function () {
  var _ref7 = _asyncToGenerator(regeneratorRuntime.mark(function _callee7(criteria, sessionToken) {
    return regeneratorRuntime.wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            return _context7.abrupt('return', _microBusinessParseServerCommon.ServiceBase.exists(StapleItemService.buildSearchQuery, criteria, sessionToken));
...
StapleItemService.buildSearchQuery = function (criteria) {
  ...
  _microBusinessParseServerCommon.ServiceBase.addEqualityQuery(conditions, query, 'addedByUser', 'addedByUser');
  ...
  if (conditions.has('user')) {
    var _value2 = conditions.get('user');

    if (_value2) {
      query.equalTo('user', _value2);
    }
  }
