    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt('return', _ServiceBase3.default.create(_schema.StapleShoppingList, info, acl, sessionToken));
          ...
          case 2:
            ...
            return _bluebird2.default.each(splittedItems.toArray(), function (chunck) {
              return Promise.all(chunck.map(function (item) {
                return StapleShoppingListService.create(item.set('userId', userId), acl, sessionToken);
              }).toArray());
            });
