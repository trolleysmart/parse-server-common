    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _schema.CrawlSession.spawn(info).save();
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return _microBusinessParseServerCommon.ParseWrapperService.createQuery(_schema.CrawlSession).equalTo('objectId', id).limit(1).find();
          ...
          case 2:
            ...
            throw new _microBusinessParseServerCommon.Exception('No crawl session found with Id: ' + id);

          case 5:
            return _context2.abrupt('return', new _schema.CrawlSession(results[0]).getInfo());
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return _microBusinessParseServerCommon.ParseWrapperService.createQuery(_schema.CrawlSession).equalTo('objectId', info.get('id')).limit(1).find();
          ...
          case 2:
            ...
            throw new _microBusinessParseServerCommon.Exception('No crawl session found with Id: ' + info.get('id'));

          case 7:
            object = new _schema.CrawlSession(results[0]);
            _context3.next = 10;
    ...
    return regeneratorRuntime.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.next = 2;
            return CrawlSessionService.buildSearchQuery(criteria).find();
    ...
    return regeneratorRuntime.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            _context6.next = 2;
            return CrawlSessionService.count(criteria);
    ...
    return regeneratorRuntime.wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            return _context7.abrupt('return', CrawlSessionService.buildSearchQuery(criteria).count());
