...
function createStoreCrawlerConfiguration(storeCrawlerConfigurationInfo) {
  return _.StoreCrawlerConfiguration.spawn(storeCrawlerConfigurationInfo || createStoreCrawlerConfigurationInfo());
}
...
describe('public methods', function () {
  test('getObject should return provided object', function () {
    var object = _.StoreCrawlerConfiguration.spawn(createStoreCrawlerConfigurationInfo());

    expect(new _.StoreCrawlerConfiguration(object).getObject()).toBe(object);
  });

  test('getId should return provided object Id', function () {
    var object = createStoreCrawlerConfiguration();

    expect(new _.StoreCrawlerConfiguration(object).getId()).toBe(object.id);
  });
