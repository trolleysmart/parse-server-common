...
var createProductPriceInfo = exports.createProductPriceInfo = function () {
  var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
    var chance, store, tags, productPrice;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            _context.next = 6;
            return (0, _TagService2.default)(new _chance2.default().integer({ min: 1, max: 10 }));
          ...
          case 6:
            ...
            return _context.abrupt('return', { productPrice: productPrice, store: store, tags: tags });
