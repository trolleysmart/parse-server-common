...
var StapleShoppingListDetailsTemplate = function (_BaseObject) {
  ...
  function StapleShoppingListDetailsTemplate(object) {
    ...
    var _this = _possibleConstructorReturn(this, (StapleShoppingListDetailsTemplate.__proto__ || Object.getPrototypeOf(StapleShoppingListDetailsTemplate)).call(this, object, 'StapleShoppingListDetailsTemplate'));
...
StapleShoppingListDetailsTemplate.updateInfoInternal = function (object, info) {
  ...
  if (info.has('stapleShoppingListTemplateIds')) {
    ...
    if (stapleShoppingListTemplateIds.isEmpty()) {
      ...
      object.set('stapleShoppingListTemplates', stapleShoppingListTemplateIds.map(function (stapleShoppingListTemplateId) {
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.getInfo = function () {
    ...
    var stapleShoppingListTemplates = stapleShoppingListTemplateObjects ? _immutable2.default.fromJS(stapleShoppingListTemplateObjects).map(function (stapleShoppingListTemplate) {
    ...
    return (0, _immutable.Map)({
      ...
      stapleShoppingListTemplateIds: stapleShoppingListTemplates ? stapleShoppingListTemplates.map(function (stapleShoppingListTemplate) {
