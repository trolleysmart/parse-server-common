...
export default class StapleTemplateService {
  ...
  static search = criteria => new Promise((resolve, reject) => StapleTemplateService.buildSearchQuery(criteria)
    .find()
  ...
  static exists = criteria => new Promise((resolve, reject) => StapleTemplateService.buildSearchQuery(criteria)
    .count()
