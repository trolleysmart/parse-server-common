...
export default class StoreService {
  ...
  static search = criteria => new Promise((resolve, reject) => StoreService.buildSearchQuery(criteria)
    .find()
  ...
  static exists = criteria => new Promise((resolve, reject) => StoreService.buildSearchQuery(criteria)
    .count()
