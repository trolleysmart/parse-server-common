...
export default class StoreCrawlerConfigurationService {
  ...
  static search = criteria => new Promise((resolve, reject) => StoreCrawlerConfigurationService.buildSearchQuery(criteria)
    .find()
  ...
  static exists = criteria => new Promise((resolve, reject) => StoreCrawlerConfigurationService.buildSearchQuery(criteria)
    .count()
