...
export default class StapleTemplateShoppingListService {
  ...
  static search = criteria => new Promise((resolve, reject) => StapleTemplateShoppingListService.buildSearchQuery(criteria)
    .find()
  ...
  static exists = criteria => new Promise((resolve, reject) => StapleTemplateShoppingListService.buildSearchQuery(criteria)
    .count()
