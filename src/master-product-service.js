...
export default class MasterProductService {
  ...
  static search = criteria => new Promise((resolve, reject) => MasterProductService.buildSearchQuery(criteria)
    .find()
  ...
  static exists = criteria => new Promise((resolve, reject) => MasterProductService.buildSearchQuery(criteria)
    .count()
