...
const createCriteria = productPrice =>
  Map({
    conditions: Map({
      ...
      barcode: productPrice ? productPrice.get('barcode') : uuid(),
      size: productPrice ? productPrice.get('size') : uuid(),
      imageUrl: productPrice ? productPrice.get('imageUrl') : uuid(),
      productPageUrl: productPrice ? productPrice.get('productPageUrl') : uuid(),
