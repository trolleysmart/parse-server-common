...
export default class CrawlResultService {
  ...
  static search = criteria => new Promise((resolve, reject) => CrawlResultService.buildSearchQuery(criteria)
    .find()
  ...
  static exists = criteria => new Promise((resolve, reject) => CrawlResultService.buildSearchQuery(criteria)
    .count()
