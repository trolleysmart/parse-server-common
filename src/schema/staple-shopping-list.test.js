...
function expectStapleShoppingListInfo(stapleShoppingListInfo, expectedStapleShoppingListInfo) {
  expect(stapleShoppingListInfo.get('userId'))
    .toBe(expectedStapleShoppingListInfo.get('userId'));
  expect(stapleShoppingListInfo.get('description'))
    .toBe(expectedStapleShoppingListInfo.get('description'));
}

describe('constructor', () => {
  test('should set class name', () => {
    expect(createStapleShoppingList()
        .className)
      .toBe('StapleShoppingList');
  });
});
...
describe('public methods', () => {
  test('getObject should return provided object', () => {
    ...
    expect(new StapleShoppingList(object)
        .getObject())
      .toBe(object);
  });
