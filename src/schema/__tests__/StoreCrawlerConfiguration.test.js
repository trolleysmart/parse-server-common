...
import { StoreCrawlerConfiguration } from '../';
...
describe('public methods', () => {
  test('getObject should return provided object', () => {
    ...
    expect(new StoreCrawlerConfiguration(object).getObject()).toBe(object);
  });

  test('getId should return provided object Id', () => {
    const object = createStoreCrawlerConfiguration();

    expect(new StoreCrawlerConfiguration(object).getId()).toBe(object.id);
  });
