...
import Tag from './Tag';
import CrawledStoreProduct from './CrawledStoreProduct';

export default class CrawledProductPrice extends BaseObject {
  static spawn = (info) => {
    const object = new CrawledProductPrice();
  ...
  static updateInfoInternal = (object, info) => {
    ...
    BaseObject.createPointer(object, info, 'crawledStoreProduct', CrawledStoreProduct);
  };

  constructor(object) {
    super(object, 'CrawledProductPrice');
  }

  updateInfo = (info) => {
    CrawledProductPrice.updateInfoInternal(this.getObject(), info);
  ...
  getInfo = () => {
    ...
    const crawledStoreProduct = new CrawledStoreProduct(object.get('crawledStoreProduct'));
